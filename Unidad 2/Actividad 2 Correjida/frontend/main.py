...
class EstudianteApp:
    def __init__(self, root):
        ...
        # Botones
        tk.Button(root, text="Agregar", command=self.agregar_estudiante).grid(row=4, column=0, padx=10, pady=10)
        tk.Button(root, text="Actualizar", command=self.actualizar_estudiante).grid(row=4, column=1, padx=10, pady=10)
        tk.Button(root, text="Eliminar", command=self.eliminar_estudiante).grid(row=4, column=2, padx=10, pady=10)
